...
// 0-warrior
	...
	{ job: 1, group: 3, enabled: true, to: 30230, instance: true, replace: true }, // Lancer -> Onslaught SpeedCast
	// { job: 1, group: 5, enabled: true, to: 50130, instance: true, replace: true }, // Lancer -> Shield Bash SpeedCast
	{ job: 1, group: 10, enabled: true, to: 100300, instance: true, replace: true }, // Lancer -> Debilitate SpeedCast
	...
	// { job: 1, group: 24, enabled: true, to: 240102, instance: true, replace: true }, // Lancer -> Giga
	...
	// { job: 3, group: 34, enabled: true, to: 340130, instance: true, replace: true }, // Unleashed: Dexter
	// { job: 3, group: 35, enabled: true, to: 350130, instance: true, replace: true }, // Unleashed: Sinister
	// { job: 3, group: 36, enabled: true, to: 360130, instance: true, replace: true }, // Unleashed: Rampage
	// { job: 3, group: 37, enabled: true, to: 370130, instance: true, replace: true }, // Unleashed: Beast Fury
	// { job: 3, group: 41, enabled: true, to: 41530, instance: true, replace: true }, // Flatten XV - > IV Charge


	// 4-sorcerer
	// { job: 4, group: 36, enabled: true, to: 360600, instance: true, replace: true }, // Sorc -> Fusion
	// { job: 4, group: 34, enabled: false, to: 340220, instance: true, replace: true }, // Sorc -> Mana Boost (not for replacing purposes)
	// { job: 4, group: 6, enabled: true, to: 320100, instance: false, replace: true }, // Sorc -> Fireblast -> Apex
	...
	// { job: 5, group: 29, enabled: true, to: 291000, instance: true, replace: true }, // ThunderBolt - > Fast


	// 6-priest

	{ job: 6, group: 3, enabled: true, to: 30730, instance: true, replace: true }, // Priest -> Healing Circle Buff + SpeedCast
	// { job: 6, group: 11, enabled: false, pve: true, to: 111102, to_pve: 111102, instance: true, replace: true }, // Priest -> Metamorphic Blast -> SpeedCast

	// { job: 6, group: 1, enabled: true, pve: true, to: 111102, to_pve: 111102, instance: true, replace: true }, // Priest -> Auto Atack -> Metamorphic Blast -> SpeedCast
	{ job: 6, group: 16, enabled: true, pve: true, to: 161121, to_pve: 161121, instance: true, replace: true }, // Priest -> Shocking Implosion -> SpeedCast (set pve to true for Apex buff)
	{ job: 6, group: 27, enabled: true, pve: true, to: 271121, to_pve: 271121, instance: true, replace: true }, // Priest -> Final Reprisal -> SpeedCast (set pve to true for Apex buff)
	...
	// { job: 6, group: 42, enabled: true, to: 423120, instance: true, replace: false }, // Priest -> HolyBurst
	...
	// { job: 9, group: 9, enabled: true, adv: false, to: 91012, to_adv: 93112, instance: true, replace: true }, // Gunner -> Mana Missiles
	...
	{ job: 9, group: 40, enabled: true, abn: 10152345, to: 400101, to_abn: 400102, instance: true, replace: true }, // Gunner -> No CD I-frame
	{ job: 9, group: 43, enabled: true, to: 430151, instance: true, replace: true }, // Gunner -> Remote Trigger -> Apex RemoteTrigger (No CD)


	// 10-brawler

	// { job: 10, group: 1, enabled: false, to: 21201, instance: true, replace: true }, // Brawler -> Punch to Stagger
	...
	// { job: 11, group: 15, enabled: true, to: 150732, instance: true, replace: true }, // Ninja -> Fire
